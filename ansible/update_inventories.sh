...
# Paths and Variables
TERRAFORM_OUTPUT_DIR="\Multi-Env-IaC\terraform"  # Replace with the actual Terraform directory path
ANSIBLE_INVENTORY_DIR="\Multi-Env-IaC\ansible\inventories"
...
update_inventory_file() {
    ...
    echo "ansible_ssh_private_key_file=/home/devops-key" >> "$inventory_file"
